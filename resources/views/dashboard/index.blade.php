                    ...
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="mb-0 pb-0 text-xxs text-muted font-weight-light">Hotel</p>
                                <p class="text-md mt-0 pt-0 mb-0 font-weight-bold">Unassigned</p>
                                <h4 class="mb-0">5</h4>
                            </div>
                        </div>
                        ...
                        <div class="card-footer p-3">
                            <div class="d-flex ">
                                ...
                                <p class="mb-0 text-xs"> Updated yesterday. </p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-2 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="mb-0 pb-0 text-xxs text-muted font-weight-light">Hotel</p>
                                <p class="text-md mt-0 pt-0 mb-0 font-weight-bold">Today's Check-ins</p>
                                <h4 class="mb-0">2</h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                        <div class="card-footer p-3">
                            <p class="mb-0 text-xs"><span class="text-success text-xs font-weight-bolder">+3% </span>than
                                lask week</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-2 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="mb-0 pb-0 text-xxs text-muted font-weight-light">The Meadow</p>
                                <p class="text-md mt-0 pt-0 mb-0 text-capitalize font-weight-bold">Today's Bookings</p>
                                <h4 class="mb-0">34</h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                        <div class="card-footer p-3">
                            <p class="mb-0 text-xs"><span class="text-danger text-xs font-weight-bolder">-2%</span> than
                                yesterday</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-2 col-sm-6">
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="mb-0 pb-0 text-xxs text-muted font-weight-light">The Meadow</p>
                                <p class="text-md mt-0 pt-0 mb-0 text-capitalize font-weight-bold">Revenue</p>
                                <h4 class="mb-0">£754</h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                        <div class="card-footer p-3">
                            <p class="mb-0 text-xs"><span class="text-success text-xs font-weight-bolder">+5% </span>than
                                yesterday</p>
                        </div>
                    </div>
                </div>
